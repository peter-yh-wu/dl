...
from synthesizer.utils.text_ph import symbols
...
class Tacotron_ph():
    ...
    def initialize(self, inputs, input_lengths, embed_targets, text_embed_targets, mel_targets=None, 
                   stop_token_targets=None, linear_targets=None, targets_lengths=None, gta=False,
                   global_step=None, is_training=False, is_evaluating=False, split_infos=None): # TODO
        ...
        Args:
            ...
            embedding size.
            text_embed_targets: float32 Tensor with shape [N, E] where E is the text 
            embedding size.
        ...
        with tf.device(split_device):
            ...
            text_frac = (tf.cast(global_step, tf.float32)-100000)/400000
            embed = embed_targets*(1-text_frac)+text_embed_targets*text_frac
            tower_embed_targets = tf.split(embed, num_or_size_splits=hp.tacotron_num_gpus, axis=0)
    ...
    def add_optimizer(self, global_step):
        ...
        with tf.device(grad_device):
            ...
            if hp.tacotron_clip_gradients:
                clipped_gradients, _ = tf.clip_by_global_norm(avg_grads, 0.5)  # was 1.0
            else:
