...
class Encoder(nn.Module):
    ...
    def __init__(self, embedding_size, num_hidden, seq_len):
        ...
        self.pos_emb = nn.Embedding.from_pretrained(get_sinusoid_encoding_table(seq_len, num_hidden, padding_idx=0),
                                                    freeze=True)
...
class MelDecoder(nn.Module):
    '''
    Decoder Network, aka Decoder Pre-net
    '''
...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder = Encoder(hp.embedding_size, hp.hidden_size, hp.seq_len)
        self.decoder = MelDecoder(hp.hidden_size, hp.seq_len)
