...
hparams = HParams(
    ...
    tacotron_batch_size=256,  # number of training samples on each training steps (was 32)
    ...
    tacotron_initial_learning_rate=1e-5,  # starting learning rate, was 1e-3
    tacotron_final_learning_rate=1e-7,  # minimal learning rate, was 1e-5
