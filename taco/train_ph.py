...
from synthesizer.utils.text_ph import sequence_to_text
from synthesizer.hparams import hparams_debug_string
from synthesizer.feeder_ph import Feeder
...
def model_train_mode(args, feeder, hparams, global_step):
    with tf.variable_scope("Tacotron_model", reuse=tf.AUTO_REUSE) as scope:
        model = create_model_ph("Tacotron", hparams)
        model.initialize(feeder.inputs, feeder.input_lengths, feeder.speaker_embeddings, 
                         feeder.text_embeddings, feeder.mel_targets, feeder.token_targets,
...
def model_test_mode(args, feeder, hparams, global_step):
    with tf.variable_scope("Tacotron_model", reuse=tf.AUTO_REUSE) as scope:
        ...
        model.initialize(feeder.eval_inputs, feeder.eval_input_lengths, 
                         feeder.eval_speaker_embeddings, feeder.text_embeddings, feeder.eval_mel_targets,
